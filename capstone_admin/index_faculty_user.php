    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!--Filter Eligible, Ineligible, Enrolled or Graduated-->
                <form action="index_faculty_user.php" method="POST">
                    ...
                    <!--Search Box/Button-->
                    <form class="form-inline my-2 my-lg-0" action="index_faculty_user.php" method="POST">
...
if(isset($_POST['search']))
{
    ...
    #Add project Name ----------------------------------------------------------
    $search_query = "SELECT f.*,p.name FROM faculty f
...
{
    $query = "SELECT f.*,p.name FROM faculty f LEFT JOIN project p ON f.faculty_id = p.faculty_id WHERE f.faculty_id != 0 ORDER BY 1 LIMIT $startrow,20";
