    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!--Filter Eligible, Ineligible, Enrolled or Graduated-->
                <form action="index_student.php" method="POST">
                    ...
                    <!--Search Box/Button-->
                    <form class="form-inline my-2 my-lg-0" action="index_student.php" method="POST">
    ...
    if ($numrows > 0) 
    {
        ...
        if ($search_result-> num_rows > 0)
        {
            while ($row = mysqli_fetch_array($search_result))
            {
                ...
                echo "<td><a href='{$row['Resume']}'>$filename</a></td>";
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  method="post" action="StudentUpdate.php" enctype="multipart/form-data">
               ...
               <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="visa" id="visa" placeholder="Visa Status">
                </div>
                    <div class="form-group col-md-6">
                  <label for="interview">Interview Date</label>
                  <input type="date" class="form-control" name="interview" id="interview" placeholder="Interview Date">
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="file" class="form-control" name="doc" id="doc" placeholder="Resume">
                </div>
...
<script>
    $(document).ready(function(){
        $('.editbutton').on('click',function(){
            ...
            $('#inputPermemail').val(data[5]);
            $('#current').val(data[6]);
            $('#inputGradterm').val(data[7]);
            $('#inputadmitterm').val(data[8]);
            $('#inputtermGPA').val(data[9]);
            $('#inputcumGPA').val(data[10]);
            $('#inputprogressunits').val(data[11]);
            $('#inputcumunits').val(data[12]);
            $('#status').val(data[13]);
             $('#visa').val(data[14]);
            $('#interview').val(data[15]);
            $('#inputAdditional').val(data[16]);
