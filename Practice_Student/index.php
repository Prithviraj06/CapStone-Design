    ...
    <body>
        ...
        <div class="container">
                    ...
                    <table id="mytable" border="1px">
                        ...
                        //previous code for displaying contents of the database
                        
                        /*
                                 $con = mysqli_connect("localhost","root","Prna.123!","testdb");
                                  $query = "SELECT Distinct student_id, project_id ,first_name, last_name, email, perm_email, current_term, grad_term, admit_term, term_gpa, cum_gpa, in_progress_units, cum_units, status FROM student";
                ...
                <!Jquery for making the header row the filter -->
        ...
        <?php
        //Loop to read data from CSV file and insert or update in database
